...
export const config = {
  matcher: [
    "/((?!_next/static|_next/image|icon\\.svg|sitemap.xml|robots.txt|fonts/*|icons/*|quran/*|mushaf-previews/*|manifest\\.webmanifest|sw\\.js|launch\\.html|offline-ar\\.html|offline-en\\.html|\\.well-known/(?:apple-app-site-association|assetlinks\\.json)).*)",
  ],
};
