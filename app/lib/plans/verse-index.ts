 ...
 * decoupled from DEFAULT_MUSHAF_ID (ADR 0066), even though both are mushaf 2
 * following Issue #709), read once and cached at module scope, same convention as
 * app/hooks/get-surahs.ts.
 *
