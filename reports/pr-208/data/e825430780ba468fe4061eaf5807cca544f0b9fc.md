...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  3335 pixels (ratio 0.02 of all image pixels) are different.
      ...
      - generic [ref=e13]:
        ...
        - generic [ref=e16]:
          ...
          - button "Gold" [ref=e19] [cursor=pointer]:
            - img
      - generic [ref=e20]:
        - heading "Tajweed Colors" [level=3] [ref=e21]
        - generic [ref=e22]:
          - generic [ref=e23] [cursor=pointer]:
            - text: Color-code Tajweed rules
            - paragraph [ref=e24]: Highlight recitation rules like idgham, ikhfa, qalqalah, and madd with color
          - switch "Color-code Tajweed rules Highlight recitation rules like idgham, ikhfa, qalqalah, and madd with color" [ref=e25] [cursor=pointer]
      - generic [ref=e26]:
