...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  687 pixels (ratio 0.01 of all image pixels) are different.
...
- generic:
  ...
  - dialog "الإعدادات" [ref=e2]:
    ...
    - generic [ref=e6]:
      - generic [ref=e7]:
        - heading "حسابي" [level=3] [ref=e8]
        - button "تسجيل الدخول" [active] [ref=e10] [cursor=pointer]:
          - img [ref=e11]
          - text: تسجيل الدخول
      - generic [ref=e14]:
        - heading "اللغة" [level=3] [ref=e15]
        - generic [ref=e17]:
          - button "العربية" [ref=e18] [cursor=pointer]
          - button "English" [ref=e19] [cursor=pointer]
      - generic [ref=e20]:
        - heading "المظهر" [level=3] [ref=e21]
        - generic [ref=e23]:
          - button "فاتح" [ref=e24] [cursor=pointer]:
            - img
          - button "داكن" [pressed] [ref=e25] [cursor=pointer]:
            - img
          - button "ذهبي" [ref=e26] [cursor=pointer]:
            - img
      - generic [ref=e27]:
        - heading "ألوان التجويد" [level=3] [ref=e28]
        - generic [ref=e29]:
          - generic [ref=e30] [cursor=pointer]:
            - text: تلوين أحكام التجويد
            - paragraph [ref=e31]: إبراز أحكام التلاوة مثل الإدغام والإخفاء والقلقلة والمد بالألوان
          - switch "تلوين أحكام التجويد إبراز أحكام التلاوة مثل الإدغام والإخفاء والقلقلة والمد بالألوان" [ref=e32] [cursor=pointer]
