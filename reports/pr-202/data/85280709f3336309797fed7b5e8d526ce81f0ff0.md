...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  7823 pixels (ratio 0.01 of all image pixels) are different.
...
- generic:
  ...
  - dialog "الإعدادات" [ref=e2]:
    ...
    - generic [ref=e6]:
      ...
      - generic [ref=e29]:
        - heading "الإشعارات" [level=3] [ref=e30]
        - generic [ref=e31]:
          - generic [ref=e32] [cursor=pointer]:
            - text: إشعارات الدفع
            - paragraph [ref=e33]: احصل على إشعارات بالتذكيرات والتحديثات على هذا الجهاز
          - switch "إشعارات الدفع احصل على إشعارات بالتذكيرات والتحديثات على هذا الجهاز" [ref=e34] [cursor=pointer]
