...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  9629 pixels (ratio 0.01 of all image pixels) are different.
...
- generic:
  ...
  - dialog "Settings" [ref=e2]:
    ...
    - generic [ref=e6]:
      ...
      - generic [ref=e29]:
        - heading "Notifications" [level=3] [ref=e30]
        - generic [ref=e31]:
          - generic [ref=e32] [cursor=pointer]:
            - text: Push notifications
            - paragraph [ref=e33]: Get notified about reminders and updates on this device
          - switch "Push notifications Get notified about reminders and updates on this device" [ref=e34] [cursor=pointer]
