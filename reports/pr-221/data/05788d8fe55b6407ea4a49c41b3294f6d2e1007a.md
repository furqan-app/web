...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  8535 pixels (ratio 0.01 of all image pixels) are different.
...
- generic:
  ...
  - dialog "الإعدادات" [ref=e2]:
    ...
    - generic [ref=e6]:
      ...
      - generic [ref=e23]:
        - heading "ألوان التجويد" [level=3] [ref=e24]
        - generic [ref=e25]:
          - generic [ref=e26] [cursor=pointer]:
            - text: تلوين أحكام التجويد
            - paragraph [ref=e27]: إبراز أحكام التلاوة مثل الإدغام والإخفاء والقلقلة والمد بالألوان
          - switch "تلوين أحكام التجويد إبراز أحكام التلاوة مثل الإدغام والإخفاء والقلقلة والمد بالألوان" [ref=e28] [cursor=pointer]
      - generic [ref=e29]:
