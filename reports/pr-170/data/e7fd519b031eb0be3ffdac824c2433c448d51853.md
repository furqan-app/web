...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  8612 pixels (ratio 0.03 of all image pixels) are different.
...
- generic:
  ...
  - dialog "الإعدادات" [ref=e2]:
    ...
    - generic [ref=e6]:
      ...
      - generic [ref=e26]:
        - heading "الإشعارات" [level=3] [ref=e27]
        - generic [ref=e28]:
          - generic [ref=e29] [cursor=pointer]:
            - text: إشعارات الدفع
            - paragraph [ref=e30]: احصل على إشعارات بالتذكيرات والتحديثات على هذا الجهاز
          - switch "إشعارات الدفع احصل على إشعارات بالتذكيرات والتحديثات على هذا الجهاز" [ref=e31] [cursor=pointer]
